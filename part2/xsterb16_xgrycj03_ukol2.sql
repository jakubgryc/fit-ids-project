...
create table osoba(
    id_osoby int generated as identity primary key not null,
...
create table kavarna(
    id_kavarny int generated as identity primary key not null,
...
create table recenze(
    id_recenze int generated as identity primary key not null,
...
insert into kavarna(nazev, mesto, psc, ulice, cislo_popisne, kapacita, popis, cas_otevreni, cas_zavreni)
values ('Dobre rano', 'Brno', '61200', 'Purkynova', '1234', '30', 'Nove otevrena kavarna v retro stylu', '08:00', '21:00');
...
insert into osoba(jmeno, prijmeni, datum_narozeni, telefon, email)
values ('Josef', 'Novak', to_date('12.12.2000', 'dd.mm.yyyy'), '+420731054882', 'josef.novak@gmail.com');
...
insert into osoba(jmeno, prijmeni, datum_narozeni, telefon, email)
values ('Libor', 'Hrncir', to_date('11.11.1999', 'dd.mm.yyyy'), '+420739425872', 'libor.hrncir@email.cz');
